...
* This is **a sample project for Software Engineering (SE) students**.<br>
  ...
  * as a case study
* The project simulates an ongoing software project for a desktop application (called _PowerRoster_) used by Personal Trainers in managing the contact details, as well as other fitness and workout related information about their clients. 
